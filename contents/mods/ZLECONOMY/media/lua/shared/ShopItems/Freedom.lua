Shop.Items["BasementMod.BasementsMag_medium"] = {
...
Shop.Items["Base.BerrilShirtFreedom"] = {
	tab = Tab.Freedom, price =120,
}

Shop.Items["Base.BerrilPantsFreedom"] = {
	tab = Tab.Freedom, price =95,
}

Shop.Items["Base.Armor_6B13"] = {
	tab = Tab.Freedom, price =14000,
}

Shop.Items["Base.BerrilVestFreedom"] = {
	tab = Tab.Freedom, price =220,
}

Shop.Items["Base.ExohelmetFreedom"] = {
	tab = Tab.Freedom, price = 6500,
}

Shop.Items["Base.ExoskeletonFreedom"] = {
	tab = Tab.Freedom, price = 20000,
}

Shop.Items["Base.ExoBackpackFreedom"] = {
	tab = Tab.Freedom, price = 10000,
}

Shop.Items["Base.ExosuitBootsFreedom"] = {
	tab = Tab.Freedom, price = 2500,
}

Shop.Items["Base.ExosuitVestFreedom"] = {
	tab = Tab.Freedom, price = 6500,
}

Shop.Items["Base.ExosuitGlovesFreedom"] = {
	tab = Tab.Freedom, price = 2000,
}

Shop.Items["Base.ExosuitJacketFreedom"] = {
	tab = Tab.Freedom, price = 4500,
}

Shop.Items["Base.ExosuitPantsFreedom"] = {
	tab = Tab.Freedom, price = 4500,
}

Shop.Items["Base.KeeperOfFreedomhirtDOWN"] = {
	tab = Tab.Freedom, price =140,
}

Shop.Items["Base.KeeperOfFreedomPants"] = {
	tab = Tab.Freedom, price =120,
}

Shop.Items["Base.KeeperOfFreedomVest"] = {
	tab = Tab.Freedom, price =220,
}

Shop.Items["Base.PBF2Freedom"] = {
	tab = Tab.Freedom, price =230,
}

Shop.Items["Base.RookieJacketFreedom"] = {
	tab = Tab.Freedom, price =125,
}

Shop.Items["Base.SEVABackpackFreedom"] = {
	tab = Tab.Freedom, price =550,
}

Shop.Items["Base.SEVAHelmFreedom"] = {
	tab = Tab.Freedom, price =300,
}

Shop.Items["Base.SentinelOfFreedomhirt"] = {
	tab = Tab.Freedom, price =140,
}

Shop.Items["Base.SentinelOfFreedomhirt"] = {
	tab = Tab.Freedom, price =130,
}

Shop.Items["Base.SentinelOfFreedomVest"] = {
	tab = Tab.Freedom, price =260,
}

Shop.Items["Base.Shereo8MaskFreedom"] = {
	tab = Tab.Freedom, price =900,
}

Shop.Items["Base.WatchmanOfFreedomhirt"] = {
	tab = Tab.Freedom, price =90,
}

Shop.Items["Base.WatchmanOfFreedomPants"] = {
	tab = Tab.Freedom, price =80,
}

Shop.Items["Base.WatchmanOfFreedomVest"] = {
	tab = Tab.Freedom, price =220,
}

Shop.Items["Base.windoffreedomjacketup"] = {
	tab = Tab.Freedom, price =155,
}

Shop.Items["Base.windoffreedompants"] = {
	tab = Tab.Freedom, price =95,
}
...
Shop.Items["Base.Mov_PosterOmega"] = {
	tab = Tab.Freedom, price = 150,
}

Shop.Items["Base.Mov_PaintingElisa"] = {
	tab = Tab.Freedom, price = 500,
}

Shop.Items["Base.Mov_PaintingLibrary"] = {
	tab = Tab.Freedom, price = 300,
}

Shop.Items["Base.Mov_PosterDroids"] = {
	tab = Tab.Freedom, price = 200,
}

Shop.Items["Base.Mov_PaintingBetty"] = {
	tab = Tab.Freedom, price = 450,
}
